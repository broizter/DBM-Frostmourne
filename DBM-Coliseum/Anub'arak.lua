...
mod:RegisterEvents(
	...
	"SPELL_AURA_REFRESH 67574 66013 67700 68509 68510 66012 10278",
...
local timerFreezingSlash	= mod:NewCDTimer(15.32, 66012, nil, "Tank|Healer", nil, 5, nil, DBM_CORE_L.TANK_ICON)
