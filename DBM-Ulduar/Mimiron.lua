...
local timerProximityMines		= mod:NewCDTimer(28, 63027, nil, nil, nil, 3)
...
local timerNextDarkGlare		= mod:NewNextTimer(31.5, 63414, nil, nil, nil, 3, nil, DBM_CORE_L.DEADLY_ICON)
